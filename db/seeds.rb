...
song_two = Song.create(title: "I Will Not Contain You", artist_id: 6, genre: "indie-folk")
...
song_four = Song.create(title: "I Want Wind To Blow", artist_id: 6, genre: "indie-folk")
...
song_five = Song.create(title: "So What", artist_id: 3, genre: "jazz")
...
song_six = Song.create(title: "Go Gina", artist_id: 8, genre: "R&B")
...
song_seven = Song.create(title: "Biking Home", artist_id: 4, genre: "lo-fi hip-hop")
...
song_eight = Song.create(title: "Goodbye Forever", artist_id: 11, genre: "Electronica")
...
song_nine = Song.create(title: "On Sight", artist_id: 5, genre: "Hip-Hop")
...
song_ten = Song.create(title: "Sometimes", artist_id: 9, genre: "Shoegaze")
...
song_eleven = Song.create(title: "Autum Leaves", artist_id: 7, genre: "Jazz")
...
song_twelve = Song.create(title: "All Caps", artist_id: 10, genre: "Hip Hop")
...
song_water = Song.create(title: "Xtal", artist_id: 2, genre: "Ambient Techno")
